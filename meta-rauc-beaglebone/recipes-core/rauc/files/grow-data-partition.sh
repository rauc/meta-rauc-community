...
total_disk_size=$(cat /sys/block/@@DATADEV@@/size)

data_part_size=$(cat /sys/block/@@DATADEV@@/@@DATADEV@@p4/size)
data_part_start=$(cat /sys/block/@@DATADEV@@/@@DATADEV@@p4/start)
...
/usr/bin/umount /dev/@@DATADEV@@p4
/usr/sbin/sgdisk /dev/@@DATADEV@@ -e
/usr/sbin/partprobe
/usr/sbin/parted --script /dev/@@DATADEV@@ resizepart 4 100%
/usr/sbin/resize2fs /dev/@@DATADEV@@p4
/usr/bin/umount /dev/@@DATADEV@@p4
/usr/sbin/e2fsck -fp /dev/@@DATADEV@@p4
/usr/bin/mount /dev/@@DATADEV@@p4 /data/
