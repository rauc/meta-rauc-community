...
data_part_size=$(cat /sys/block/mmcblk0/mmcblk0p3/size)
data_part_start=$(cat /sys/block/mmcblk0/mmcblk0p3/start)
...
/usr/bin/umount /dev/mmcblk0p3
/usr/sbin/sgdisk /dev/mmcblk0 -e
/usr/sbin/partprobe
/usr/sbin/parted --script /dev/mmcblk0 resizepart 3 100%
/usr/sbin/resize2fs /dev/mmcblk0p3
/usr/bin/umount /dev/mmcblk0p3
/usr/sbin/e2fsck -fp /dev/mmcblk0p3
/usr/bin/mount /dev/mmcblk0p3 /data/
