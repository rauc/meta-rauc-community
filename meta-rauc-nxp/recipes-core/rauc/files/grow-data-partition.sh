...
data_part_size=$(cat /sys/block/mmcblk1/mmcblk1p4/size)
data_part_start=$(cat /sys/block/mmcblk1/mmcblk1p4/start)
...
/usr/bin/umount /dev/mmcblk1p4
/usr/sbin/sgdisk /dev/mmcblk1 -e
/usr/sbin/partprobe
/usr/sbin/parted --script /dev/mmcblk1 resizepart 4 100%
/usr/sbin/resize2fs /dev/mmcblk1p4
/usr/bin/umount /dev/mmcblk1p4
/usr/sbin/e2fsck -fp /dev/mmcblk1p4
/usr/bin/mount /dev/mmcblk1p4 /data/
